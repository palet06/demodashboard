        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2 ">
              ...
              <CardTitle className="text-xl font-bold">Özet Bilgileriniz</CardTitle>
            </div>
          ...
          <div className="flex flex-col items-end">
            ...
            {statusMessage && (
              <p className={`text-sm mt-2 ${statusMessage.toLowerCase().includes("tekrar") ? "text-red-500" : "text-green-500"}`}>
                {statusMessage}
              </p>
            )}
          </div>
            ...
            <div className="bg-slate-50 p-4 rounded-lg mt-1">
              ...
              <div className="relative">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 text-xs">
                    <div className="bg-white p-3 rounded border">
                      ...
                      <ul className="space-y-1 list-disc pl-4 text-slate-600">
                        <li><Link href="https://www.csgb.gov.tr/uigm/tr" target="_blank">Genel Müdürlük Web Sayfası</Link> </li>
                        <li><Link href="https://uigmportal.csgb.gov.tr" target="_blank">UİGM Portal</Link> </li>
                        <li><Link href="https://warehouseapp.csgb.gov.tr/" target="_blank">Warehouse</Link></li>
                      </ul>
                    </div>
                    <div className="bg-white p-3 rounded border">
                    ...
                    <div className="bg-white p-3 rounded border">
                      <span className="font-medium block mb-1">Çalışma Genel Müdürlüğü</span>
                      <ul className="space-y-1 list-disc pl-4 text-slate-600">
                    ...
                    <div className="bg-white p-3 rounded border">
                      <span className="font-medium block mb-1">Personel Genel Müdürlüğü</span>
                      <ul className="space-y-1 list-disc pl-4 text-slate-600">
                        <li><Link href="#" >Personel Portal</Link> </li>
                        <li><Link href="#" >Telefon Rehberi</Link> </li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative pl-12 pb-8">
                  ...
                  <p className="text-sm text-slate-700 mb-2">
                    Çalışma ve Sosyal Güvenlik Bakanlığı ile ilgili dış kaynaklar.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                    <div className="bg-white p-3 rounded border">
                      <span className="font-medium block mb-1">Resmi Gazete</span>
                      <ul className="space-y-1 list-disc pl-4 text-slate-600">
                    ...
                    <div className="bg-white p-3 rounded border">
                      <span className="font-medium block mb-1">GÖÇ İdaresi Başkanlığı</span>
                      <ul className="space-y-1 list-disc pl-4 text-slate-600">
                        <li>İstatistikler</li>
                        <li>Raporlar</li>
